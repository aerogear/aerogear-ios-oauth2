...
open class FacebookConfig: Config {
    ...
    */
    public init(clientId: String, clientSecret: String, scopes: [String], accountId: String? = nil, isOpenIDConnect: Bool = false, additionalParameters: [String: String] = [:]) {
        super.init(base: "",
...
open class GoogleConfig: Config {
    ...
    :param: isOpenIDConnect to identify if fetching id information is required.
    */
    public init(clientId: String, scopes: [String], audienceId: String? = nil, accountId: String? = nil, isOpenIDConnect: Bool = false, additionalParameters: [String: String] = [:]) {
...
open class KeycloakConfig: Config {
    ...
    :param: isOpenIDConnect to identify if fetching id information is required.
    */
    public init(clientId: String, host: String, realm: String? = nil, isOpenIDConnect: Bool = false, additionalParameters: [String: String] = [:]) {
